    ...
    return (
        <nav className="vertical-navigation">
            <div className="vertical-navigation-images">
                ...
                <NavLink to="/mock/12"><img src={Cycle} alt="Cycle" className="vertical-navigation-image"/></NavLink>
                <NavLink to="/mock/18"><img src={Weight} alt="Weight" className="vertical-navigation-image"/></NavLink>
            </div>
