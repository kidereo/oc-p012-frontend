    ...
    return (
        <nav className="vertical-navigation">
            <div className="vertical-navigation-images">
                ...
                <NavLink to="/user/2"><img src={Cycle} alt="Cycle" className="vertical-navigation-image"/></NavLink>
                <NavLink to="/user/8"><img src={Weight} alt="Weight" className="vertical-navigation-image"/></NavLink>
            </div>
